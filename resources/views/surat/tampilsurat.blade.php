    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-8">
                <div class="card">
                    <div class="card-body">
                        <form action="/updatesurat/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                                ...
                                <input type="text" name="nomor" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" value="{{ $data->nomor}}">
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="date" name="tgl_surat" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" value="{{ $data->tgl_surat}}">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="perihal" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" value="{{ $data->perihal}}">
                            </div>
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="seksi" aria-label="Default select example">
                                    <option selected>{{ $data->seksi}}</option>
